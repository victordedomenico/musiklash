      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          <section className="space-y-3">
            ...
            <p>
              MusiKlash n&apos;héberge aucun fichier audio. Les extraits musicaux (30 secondes) sont
              fournis directement par l&apos;<strong>API Deezer</strong> via des URL de streaming
              temporaires. Les œuvres musicales restent la propriété exclusive de leurs ayants droit
              respectifs (artistes, labels, éditeurs).
            </p>
            <p>
              Conformément aux conditions d&apos;utilisation de l&apos;API Deezer, la diffusion de
              ces extraits est réservée à un{" "}
              <strong>usage strictement privé dans le cercle familial</strong>. L&apos;écoute est
              limitée à 30 secondes par titre. MusiKlash ne stocke pas les fichiers audio localement
              et ne diffuse que des extraits validés via l&apos;API Deezer.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              protégés par le droit d&apos;auteur © 2026 MusiKlash. Toute reproduction, même
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              En les rendant publics, ils accordent à MusiKlash une licence non exclusive
          ...
          <section className="space-y-3">
            ...
            <p>
              Si vous estimez que du contenu sur MusiKlash porte atteinte à vos droits,
              contactez-nous à{" "}
              <a
