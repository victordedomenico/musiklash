...
export const metadata: Metadata = { title: "Conditions d'utilisation — CharacterKlash" };
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          <section className="space-y-3">
            ...
            <p>
              En utilisant CharacterKlash, vous acceptez les présentes conditions. Si vous n&apos;êtes pas
          ...
          <section className="space-y-3">
            ...
            <p>
              CharacterKlash est accessible gratuitement. La création d&apos;un compte peut être requise pour
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              ayants droit. CharacterKlash n&apos;héberge aucun fichier numérique de bande dessinée.
              L&apos;interface et le code sont protégés par le droit d&apos;auteur © 2026 CharacterKlash.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Pour toute question :{" "}
              <a href="mailto:contact@comicklash.app" style={{ color: "var(--accent)" }} className="hover:underline">
                contact@comicklash.app
              </a>
            </p>
          </section>
        </div>
