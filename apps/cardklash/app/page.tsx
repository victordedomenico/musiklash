...
export const metadata: Metadata = buildPageMetadata({
  title: "Tournois cartes TCG en ligne gratuits",
  description:
    "Crée des brackets et tierlists de cartes à collectionner. Vote pour tes cartes Magic, sets et decks préférés. CardKlash — 100 % gratuit.",
  path: "/",
});

export default async function Home() {
  const { t } = await getI18n();
  const topCards = await getTopCards(18);
  const marqueeItems = topCards.length > 0 ? [...topCards, ...topCards] : [];
    ...
    <>
      <JsonLd
        data={{
          ...
          url: absoluteUrl(),
          description:
            "Plateforme gratuite de jeux autour des cartes TCG : brackets et tierlists.",
        }}
      />
      <div className="space-y-4">
        ...
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(900px 480px at 55% 10%, rgba(245,158,11,0.22) 0%, rgba(251,191,36,0.10) 45%, transparent 78%)",
            }}
          />
