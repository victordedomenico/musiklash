...
export const metadata: Metadata = { title: "Conditions d'utilisation — CardKlash" };
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          <section className="space-y-3">
            ...
            <p>
              En utilisant CardKlash, vous acceptez les présentes conditions. Si vous n&apos;êtes pas
          ...
          <section className="space-y-3">
            ...
            <p>
              CardKlash est accessible gratuitement. La création d&apos;un compte peut être requise pour
          ...
          <section className="space-y-3">
            ...
            <p>
              Les illustrations et métadonnées proviennent de Scryfall et restent la propriété de
              leurs ayants droit (notamment Wizards of the Coast pour Magic: The Gathering).
              CardKlash n&apos;héberge aucune image de carte. L&apos;interface et le code sont protégés par
              le droit d&apos;auteur © 2026 CardKlash.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Pour toute question :{" "}
              <a href="mailto:contact@cardklash.app" style={{ color: "var(--accent)" }} className="hover:underline">
                contact@cardklash.app
              </a>
            </p>
          </section>
        </div>
