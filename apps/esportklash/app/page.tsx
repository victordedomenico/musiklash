...
export const metadata: Metadata = buildPageMetadata({
  title: "Tournois esport en ligne gratuits",
  description:
    "Crée des brackets et tierlists esport. Vote pour tes équipes, joueurs et matchs préférés. EsportKlash — 100 % gratuit.",
  path: "/",
});
    ...
    <>
      <JsonLd
        data={{
          ...
          url: absoluteUrl(),
          description:
            "Plateforme gratuite d'esport : brackets et tierlists autour des matchs et équipes.",
        }}
      />
