...
export const metadata: Metadata = { title: "Conditions d'utilisation — SportKlash" };
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          <section className="space-y-3">
            ...
            <p>
              En utilisant SportKlash, vous acceptez les présentes conditions. Si vous n&apos;êtes pas
          ...
          <section className="space-y-3">
            ...
            <p>
              SportKlash est accessible gratuitement. La création d&apos;un compte peut être requise pour
          ...
          <section className="space-y-3">
            ...
            <p>
              Les données sportives (équipes, joueurs, matchs) proviennent de TheSportsDB et restent la
              propriété de leurs ayants droit. SportKlash n&apos;héberge aucun flux live. L&apos;interface et le
              code sont protégés par le droit d&apos;auteur © 2026 SportKlash.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Pour toute question :{" "}
              <a href="mailto:contact@sportklash.app" style={{ color: "var(--accent)" }} className="hover:underline">
                contact@sportklash.app
              </a>
            </p>
          </section>
        </div>
