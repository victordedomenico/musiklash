...
export const metadata: Metadata = buildPageMetadata({
  title: "Tournois jeux vidéo en ligne gratuits",
  description:
    "Crée des brackets et tierlists gaming. Vote pour tes jeux, franchises et studios préférés. GameKlash — 100 % gratuit.",
  path: "/",
});
    ...
    <>
      <JsonLd
        data={{
          ...
          url: absoluteUrl(),
          description:
            "Plateforme gratuite de jeux vidéo : brackets et tierlists autour des jeux.",
        }}
      />
