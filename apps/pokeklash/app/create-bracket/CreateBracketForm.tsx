...
import PokemonPicker, { type SelectedItem } from "@/components/PokemonPicker";
...
export default function CreateBracketForm() {
  ...
  const onSubmit: React.FormEventHandler<HTMLFormElement> = (e) => {
    ...
    if (selected.length < 3) {
      setError("Sélectionne au moins 3 Pokémon.");
      return;
    }
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      <PokemonPicker size={size} selected={selected} onChange={setSelected} />
