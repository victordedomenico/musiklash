...
import CountryPicker, { type SelectedItem } from "@/components/CountryPicker";
...
export default function CreateTierlistForm() {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div>
          ...
          <Input
            ...
            placeholder="Ex. Drapeaux les plus reconnaissables"
          />
        </div>
        <div>
      ...
      <CountryPicker size={64} selected={items} onChange={setItems} freeMode />
