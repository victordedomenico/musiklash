...
export const metadata: Metadata = { title: "Conditions d'utilisation — CountryKlash" };
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          <section className="space-y-3">
            ...
            <p>
              En utilisant CountryKlash, vous acceptez les présentes conditions. Si vous n&apos;êtes pas
          ...
          <section className="space-y-3">
            ...
            <p>
              CountryKlash est accessible gratuitement. La création d&apos;un compte peut être requise pour
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              via Wikidata. CountryKlash n&apos;héberge aucun contenu propriétaire. L&apos;interface et le
              code sont protégés par le droit d&apos;auteur © 2026 CountryKlash.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Pour toute question :{" "}
              <a href="mailto:contact@countryklash.app" style={{ color: "var(--accent)" }} className="hover:underline">
                contact@countryklash.app
              </a>
            </p>
          </section>
        </div>
