...
export const metadata: Metadata = buildPageMetadata({
  title: "Quiz géo en ligne gratuits",
  description:
    "Crée des brackets et tierlists de pays, capitales, drapeaux et cultures. CountryKlash — 100 % gratuit.",
  path: "/",
});
    ...
    <>
      <JsonLd
        data={{
          ...
          url: absoluteUrl(),
          description:
            "Plateforme gratuite de quiz géo : brackets et tierlists autour des pays, capitales et drapeaux.",
        }}
      />
          ...
          <div className="relative">
            ...
            >
              ...
              <span
                ...
                style={{
                  background: "linear-gradient(90deg, #16a34a 5%, #22c55e 45%, #86efac 85%)",
