...
import { getTopBoardGames } from "@/lib/top-boardgames";
import { absoluteUrl, buildPageMetadata, SITE_NAME } from "@/lib/seo";

export const metadata: Metadata = buildPageMetadata({
  title: "Tournois jeux de société en ligne gratuits",
  description:
    "Crée des brackets et tierlists de jeux de plateau. Vote pour tes jeux, mécaniques et catégories préférés. BoardKlash — 100 % gratuit.",
  path: "/",
});

export default async function Home() {
  const { t } = await getI18n();
  const topGames = await getTopBoardGames(18);
    ...
    <>
      <JsonLd
        data={{
          ...
          url: absoluteUrl(),
          description:
            "Plateforme gratuite de jeux de société : brackets et tierlists autour des jeux de plateau.",
        }}
      />
      <div className="space-y-4">
        ...
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(900px 480px at 55% 10%, rgba(245,158,11,0.22) 0%, rgba(217,119,6,0.10) 45%, transparent 78%)",
            }}
          />
