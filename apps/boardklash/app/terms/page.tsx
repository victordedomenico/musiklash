...
export const metadata: Metadata = { title: "Conditions d'utilisation — BoardKlash" };
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          <section className="space-y-3">
            ...
            <p>
              En utilisant BoardKlash, vous acceptez les présentes conditions. Si vous n&apos;êtes pas
          ...
          <section className="space-y-3">
            ...
            <p>
              BoardKlash est accessible gratuitement. La création d&apos;un compte peut être requise pour
          ...
          <section className="space-y-3">
            ...
            <p>
              Les couvertures et métadonnées proviennent de BoardGameGeek et restent la propriété de leurs
              ayants droit. BoardKlash n&apos;héberge aucun fichier de jeu. L&apos;interface et le code sont
              protégés par le droit d&apos;auteur © 2026 BoardKlash.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Pour toute question :{" "}
              <a href="mailto:contact@boardklash.app" style={{ color: "var(--accent)" }} className="hover:underline">
                contact@boardklash.app
              </a>
            </p>
          </section>
        </div>
