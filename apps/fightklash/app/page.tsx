...
export const metadata: Metadata = buildPageMetadata({
  title: "Tournois MMA en ligne gratuits",
  description:
    "Crée des brackets et tierlists MMA. Vote pour tes fighters, combats et catégories préférés. FightKlash — 100 % gratuit.",
  path: "/",
});

export default async function Home() {
  const { t } = await getI18n();
  const topMatches = await getTopMatches(18);
  const marqueeItems = topMatches.length > 0 ? [...topMatches, ...topMatches] : [];
    ...
    <>
      <JsonLd
        data={{
          ...
          url: absoluteUrl(),
          description:
            "Plateforme gratuite de MMA : brackets et tierlists autour des combats, fighters et organisations.",
        }}
      />
      <div className="space-y-4">
        ...
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(900px 480px at 55% 10%, rgba(139,92,246,0.22) 0%, rgba(99,102,241,0.10) 45%, transparent 78%)",
            }}
          />
