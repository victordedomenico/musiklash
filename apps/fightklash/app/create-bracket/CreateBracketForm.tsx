...
import EsportPicker, { type SelectedItem } from "@/components/EsportPicker";
...
export default function CreateBracketForm() {
  ...
  const onSubmit: React.FormEventHandler<HTMLFormElement> = (e) => {
    ...
    if (selected.length < 3) {
      setError("Sélectionne au moins 3 combats ou fighters.");
      return;
    }
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      <EsportPicker size={size} selected={selected} onChange={setSelected} />
