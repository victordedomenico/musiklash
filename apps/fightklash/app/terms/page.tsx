...
export const metadata: Metadata = { title: "Conditions d'utilisation — FightKlash" };
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          <section className="space-y-3">
            ...
            <p>
              En utilisant FightKlash, vous acceptez les présentes conditions. Si vous n&apos;êtes pas
          ...
          <section className="space-y-3">
            ...
            <p>
              FightKlash est accessible gratuitement. La création d&apos;un compte peut être requise pour
          ...
          <section className="space-y-3">
            ...
            <p>
              Les données de combats, fighters et organisations proviennent de API-Sports MMA et
              Wikipedia (métadonnées complémentaires) et restent la propriété de leurs ayants droit.
              FightKlash n&apos;héberge aucun flux live. L&apos;interface et le code sont protégés par le droit
              d&apos;auteur © 2026 FightKlash.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Pour toute question :{" "}
              <a href="mailto:contact@fightklash.app" style={{ color: "var(--accent)" }} className="hover:underline">
                contact@fightklash.app
              </a>
            </p>
          </section>
        </div>
