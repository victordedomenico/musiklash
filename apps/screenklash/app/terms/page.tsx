...
export const metadata: Metadata = { title: "Conditions d'utilisation — ScreenKlash" };
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          <section className="space-y-3">
            ...
            <p>
              En utilisant ScreenKlash, vous acceptez les présentes conditions. Si vous n&apos;êtes pas
          ...
          <section className="space-y-3">
            ...
            <p>
              ScreenKlash est accessible gratuitement. La création d&apos;un compte peut être requise pour
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              propriété de leurs ayants droit. ScreenKlash n&apos;héberge aucun fichier vidéo. L&apos;interface
              et le code sont protégés par le droit d&apos;auteur © 2026 ScreenKlash.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Pour toute question :{" "}
              <a href="mailto:contact@screenklash.app" style={{ color: "var(--accent)" }} className="hover:underline">
                contact@screenklash.app
              </a>
            </p>
          </section>
        </div>
