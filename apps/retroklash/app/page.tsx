...
import { getTopRetroGames } from "@/lib/top-retro-games";
import { absoluteUrl, buildPageMetadata, SITE_NAME } from "@/lib/seo";

export const metadata: Metadata = buildPageMetadata({
  title: "Tournois jeux rétro en ligne gratuits",
  description:
    "Brackets et tierlists autour des jeux classiques NES, SNES, Game Boy et consoles 8/16-bit. RetroKlash — 100 % gratuit.",
  path: "/",
});

export default async function Home() {
  const { t } = await getI18n();
  const topGames = await getTopRetroGames(18);
    ...
    <>
      <JsonLd
        data={{
          ...
          url: absoluteUrl(),
          description:
            "Plateforme gratuite de jeux rétro : brackets et tierlists autour des classiques.",
        }}
      />
          ...
          <div className="relative">
            ...
            >
              ...
              <span
                ...
                style={{
                  background: "linear-gradient(90deg, #8b5cf6 5%, #a78bfa 45%, #c4b5fd 85%)",
