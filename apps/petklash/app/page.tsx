...
import { getTopPets } from "@/lib/top-pets";
import { absoluteUrl, buildPageMetadata, SITE_NAME } from "@/lib/seo";

export const metadata: Metadata = buildPageMetadata({
  title: "Tournois de races chiens & chats gratuits",
  description:
    "Crée des brackets et tierlists de races de chiens et chats. Vote pour tes compagnons préférés. PetKlash — 100 % gratuit.",
  path: "/",
});

export default async function Home() {
  const { t } = await getI18n();
  const topPets = await getTopPets(18);
  const marqueeItems = topPets.length > 0 ? [...topPets, ...topPets] : [];
    ...
    <>
      <JsonLd
        data={{
          ...
          url: absoluteUrl(),
          description:
            "Plateforme gratuite pour brackets et tierlists de races de chiens et chats.",
        }}
      />
      <div className="space-y-4">
        ...
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(900px 480px at 55% 10%, rgba(251,146,60,0.22) 0%, rgba(249,115,22,0.10) 45%, transparent 78%)",
            }}
          />
          <div className="relative">
            ...
            >
              ...
              <span
                ...
                style={{
                  background: "linear-gradient(90deg, #fb923c 5%, #f97316 45%, #fdba74 85%)",
