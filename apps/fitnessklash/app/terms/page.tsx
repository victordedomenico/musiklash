...
export const metadata: Metadata = { title: "Conditions d'utilisation — FitnessKlash" };
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          <section className="space-y-3">
            ...
            <p>
              En utilisant FitnessKlash, vous acceptez les présentes conditions. Si vous n&apos;êtes pas
          ...
          <section className="space-y-3">
            ...
            <p>
              FitnessKlash est accessible gratuitement. La création d&apos;un compte peut être requise pour
          ...
          <section className="space-y-3">
            ...
            <p>
              Les illustrations d&apos;exercices et métadonnées proviennent de l&apos;API Wger (licence
              open source) et restent la propriété de leurs contributeurs respectifs. FitnessKlash
              n&apos;héberge pas de contenus propriétaires tiers. L&apos;interface et le code sont protégés
              par le droit d&apos;auteur © 2026 FitnessKlash.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Pour toute question :{" "}
              <a
                href="mailto:contact@fitnessklash.app"
                style={{ color: "var(--accent)" }}
                className="hover:underline"
              >
                contact@fitnessklash.app
              </a>
            </p>
          </section>
        </div>
