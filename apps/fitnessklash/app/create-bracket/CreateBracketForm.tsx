...
import FitnessPicker, { type SelectedItem } from "@/components/FitnessPicker";
...
export default function CreateBracketForm() {
  ...
  const onSubmit: React.FormEventHandler<HTMLFormElement> = (e) => {
    ...
    if (selected.length < 3) {
      setError("Sélectionne au moins 3 exercices.");
      return;
    }
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      <FitnessPicker size={size} selected={selected} onChange={setSelected} />
