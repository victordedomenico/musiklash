...
import { getTopIndieGames } from "@/lib/top-indie-games";
import { absoluteUrl, buildPageMetadata, SITE_NAME } from "@/lib/seo";

export const metadata: Metadata = buildPageMetadata({
  title: "Tournois jeux indés en ligne gratuits",
  description:
    "Brackets et tierlists autour des jeux indépendants, game jams et studios. IndieKlash — 100 % gratuit.",
  path: "/",
});

export default async function Home() {
  const { t } = await getI18n();
  const topGames = await getTopIndieGames(18);
    ...
    <>
      <JsonLd
        data={{
          ...
          url: absoluteUrl(),
          description:
            "Plateforme gratuite de jeux indés : brackets et tierlists autour des pépites indépendantes.",
        }}
      />
