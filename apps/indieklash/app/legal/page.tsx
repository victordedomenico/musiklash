...
export const metadata: Metadata = { title: "Mentions légales — IndieKlash" };
...
export default function LegalPage() {
  return (
    <div className="page-shell prose prose-invert max-w-3xl py-12">
      ...
      <p>
        IndieKlash est édité par une structure indépendante. Les couvertures et métadonnées
        proviennent de{" "}
        <a href="https://rawg.io/" target="_blank" rel="noreferrer">
          RAWG Video Games Database
        </a>
        . IndieKlash n&apos;héberge aucun fichier de jeu.
      </p>
      <p>
