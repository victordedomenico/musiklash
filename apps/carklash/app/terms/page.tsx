...
export const metadata: Metadata = { title: "Conditions d'utilisation — TravelKlash" };
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          <section className="space-y-3">
            ...
            <p>
              En utilisant TravelKlash, vous acceptez les présentes conditions. Si vous n&apos;êtes pas
          ...
          <section className="space-y-3">
            ...
            <p>
              TravelKlash est accessible gratuitement. La création d&apos;un compte peut être requise pour
          ...
          <section className="space-y-3">
            ...
            <p>
              Les drapeaux et métadonnées proviennent de RestCountries et de sources ouvertes. TravelKlash
              n&apos;héberge aucun contenu propriétaire. L&apos;interface et le code sont protégés par le
              droit d&apos;auteur © 2026 TravelKlash.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Pour toute question :{" "}
              <a href="mailto:contact@travelklash.app" style={{ color: "var(--accent)" }} className="hover:underline">
                contact@travelklash.app
              </a>
            </p>
          </section>
        </div>
