...
export const metadata: Metadata = { title: "Conditions d'utilisation — SeriesKlash" };
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          <section className="space-y-3">
            ...
            <p>
              En utilisant SeriesKlash, vous acceptez les présentes conditions. Si vous n&apos;êtes pas
          ...
          <section className="space-y-3">
            ...
            <p>
              SeriesKlash est accessible gratuitement. La création d&apos;un compte peut être requise pour
          ...
          <section className="space-y-3">
            ...
            <p>
              Les affiches et métadonnées proviennent de The Movie Database (TMDB) et restent la
              propriété de leurs ayants droit. SeriesKlash n&apos;héberge aucun fichier vidéo. L&apos;interface
              et le code sont protégés par le droit d&apos;auteur © 2026 SeriesKlash.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Pour toute question :{" "}
              <a href="mailto:contact@seriesklash.app" style={{ color: "var(--accent)" }} className="hover:underline">
                contact@seriesklash.app
              </a>
            </p>
          </section>
        </div>
