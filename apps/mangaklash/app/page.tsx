...
import { getTopMangas } from "@/lib/top-mangas";
import { absoluteUrl, buildPageMetadata, SITE_NAME } from "@/lib/seo";

export const metadata: Metadata = buildPageMetadata({
  title: "Tournois manga en ligne gratuits",
  description:
    "Crée des brackets et tierlists manga. Vote pour tes séries, chapitres et auteurs préférés. MangaKlash — 100 % gratuit.",
  path: "/",
});

export default async function Home() {
  const { t } = await getI18n();
  const topMangas = await getTopMangas(18);
  const marqueeItems = topMangas.length > 0 ? [...topMangas, ...topMangas] : [];
    ...
    <>
      <JsonLd
        data={{
          ...
          url: absoluteUrl(),
          description:
            "Plateforme gratuite de jeux manga : brackets et tierlists autour des mangas.",
        }}
      />
      <div className="space-y-4">
        ...
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(900px 480px at 55% 10%, rgba(168,85,247,0.22) 0%, rgba(192,132,252,0.10) 45%, transparent 78%)",
            }}
          />
          <div className="relative">
            ...
            >
              ...
              <span
                ...
                style={{
                  background: "linear-gradient(90deg, #a855f7 5%, #c084fc 45%, #e9d5ff 85%)",
