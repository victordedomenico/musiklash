...
import BasketPicker, { type SelectedItem } from "@/components/BasketPicker";
...
export default function CreateBracketForm() {
  ...
  const onSubmit: React.FormEventHandler<HTMLFormElement> = (e) => {
    ...
    if (selected.length < 3) {
      setError("Sélectionne au moins 3 matchs.");
      return;
    }
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      <BasketPicker size={size} selected={selected} onChange={setSelected} />
