...
export const metadata: Metadata = buildPageMetadata({
  title: "Tournois football en ligne gratuits",
  description:
    "Crée des brackets et tierlists football. Vote pour tes clubs, joueurs et matchs préférés. FootKlash — 100 % gratuit.",
  path: "/",
});
    ...
    <>
      <JsonLd
        data={{
          ...
          url: absoluteUrl(),
          description:
            "Plateforme gratuite de football : brackets et tierlists autour des matchs, clubs et ligues.",
        }}
      />
