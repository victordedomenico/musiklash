...
import SneakerPicker, { type SelectedItem } from "@/components/SneakerPicker";
...
export default function CreateBracketForm() {
  ...
  const onSubmit: React.FormEventHandler<HTMLFormElement> = (e) => {
    ...
    if (selected.length < 3) {
      setError("Sélectionne au moins 3 colorways.");
      return;
    }
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      <SneakerPicker size={size} selected={selected} onChange={setSelected} />
