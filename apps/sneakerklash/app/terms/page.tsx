...
export const metadata: Metadata = { title: "Conditions d'utilisation — SneakerKlash" };
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          <section className="space-y-3">
            ...
            <p>
              En utilisant SneakerKlash, vous acceptez les présentes conditions. Si vous n&apos;êtes pas
          ...
          <section className="space-y-3">
            ...
            <p>
              SneakerKlash est accessible gratuitement. La création d&apos;un compte peut être requise pour
          ...
          <section className="space-y-3">
            ...
            <p>
              Les couvertures et métadonnées proviennent de SneaksAPI et restent la propriété de leurs
              ayants droit. SneakerKlash n&apos;héberge aucun image sneaker. L&apos;interface et le code sont
              protégés par le droit d&apos;auteur © 2026 SneakerKlash.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Pour toute question :{" "}
              <a href="mailto:contact@sneakerklash.app" style={{ color: "var(--accent)" }} className="hover:underline">
                contact@sneakerklash.app
              </a>
            </p>
          </section>
        </div>
