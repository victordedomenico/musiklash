...
type Tab = "country" | "capital" | "flag" | "culture" | "region" | "city" | "place";
...
export default function WorldPicker({ size, selected, onChange, freeMode = false }: Props) {
  ...
  const loading =
    countryLoading || capitalLoading || flagLoading || cultureLoading || regionLoading || cityLoading || placeLoading;
