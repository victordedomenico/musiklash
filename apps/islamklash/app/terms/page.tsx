...
export const metadata: Metadata = { title: "Conditions d'utilisation — IslamKlash" };
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          <section className="space-y-3">
            ...
            <p>
              En utilisant IslamKlash, vous acceptez les présentes conditions. Si vous n&apos;êtes pas
          ...
          <section className="space-y-3">
            ...
            <p>
              IslamKlash est accessible gratuitement. La création d&apos;un compte peut être requise pour
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              propriété de leurs ayants droit. IslamKlash n&apos;héberge aucun fichier numérique de livre.
              L&apos;interface et le code sont protégés par le droit d&apos;auteur © 2026 IslamKlash.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Pour toute question :{" "}
              <a href="mailto:contact@islamklash.app" style={{ color: "var(--accent)" }} className="hover:underline">
                contact@islamklash.app
              </a>
            </p>
          </section>
        </div>
