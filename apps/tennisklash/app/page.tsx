...
import { getTopPlayers } from "@/lib/top-players";
import { absoluteUrl, buildPageMetadata, SITE_NAME } from "@/lib/seo";

export const metadata: Metadata = buildPageMetadata({
  title: "Tournois tennis en ligne gratuits",
  description:
    "Crée des brackets et tierlists tennis. Vote pour tes joueurs ATP/WTA préférés. TennisKlash — 100 % gratuit.",
  path: "/",
});

export default async function Home() {
  const { t } = await getI18n();
  const topPlayers = await getTopPlayers(18);
  const marqueeItems = topPlayers.length > 0 ? [...topPlayers, ...topPlayers] : [];
    ...
    <>
      <JsonLd
        data={{
          ...
          url: absoluteUrl(),
          description:
            "Plateforme gratuite pour brackets et tierlists tennis — joueurs, tournois et surfaces.",
        }}
      />
      <div className="space-y-4">
        ...
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(900px 480px at 55% 10%, rgba(163,230,53,0.22) 0%, rgba(132,204,22,0.10) 45%, transparent 78%)",
            }}
          />
          <div className="relative">
            ...
            >
              ...
              <span
                ...
                style={{
                  background: "linear-gradient(90deg, #a3e635 5%, #84cc16 45%, #bef264 85%)",
