...
export const metadata: Metadata = { title: "Conditions d'utilisation — EsportKlash" };
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          <section className="space-y-3">
            ...
            <p>
              En utilisant EsportKlash, vous acceptez les présentes conditions. Si vous n&apos;êtes pas
          ...
          <section className="space-y-3">
            ...
            <p>
              EsportKlash est accessible gratuitement. La création d&apos;un compte peut être requise pour
          ...
          <section className="space-y-3">
            ...
            <p>
              Les données d&apos;équipes, joueurs et tournois proviennent de PandaScore et restent la
              propriété de leurs ayants droit. EsportKlash n&apos;héberge aucun flux live. L&apos;interface et le
              code sont protégés par le droit d&apos;auteur © 2026 EsportKlash.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Pour toute question :{" "}
              <a href="mailto:contact@esportklash.app" style={{ color: "var(--accent)" }} className="hover:underline">
                contact@esportklash.app
              </a>
            </p>
          </section>
        </div>
