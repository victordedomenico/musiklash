...
import { getTopBooks } from "@/lib/top-books";
import { absoluteUrl, buildPageMetadata, SITE_NAME } from "@/lib/seo";

export const metadata: Metadata = buildPageMetadata({
  title: "Tournois livres en ligne gratuits",
  description:
    "Crée des brackets et tierlists littéraires. Vote pour tes livres, auteurs et genres préférés. BookKlash — 100 % gratuit.",
  path: "/",
});

export default async function Home() {
  const { t } = await getI18n();
  const topBooks = await getTopBooks(18);
  const marqueeItems = topBooks.length > 0 ? [...topBooks, ...topBooks] : [];
    ...
    <>
      <JsonLd
        data={{
          ...
          url: absoluteUrl(),
          description:
            "Plateforme gratuite de jeux autour des livres : brackets et tierlists littéraires.",
        }}
      />
      <div className="space-y-4">
        ...
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(900px 480px at 55% 10%, rgba(16,185,129,0.22) 0%, rgba(52,211,153,0.10) 45%, transparent 78%)",
            }}
          />
          <div className="relative">
            ...
            >
              ...
              <span
                ...
                style={{
                  background: "linear-gradient(90deg, #10b981 5%, #34d399 45%, #6ee7b7 85%)",
