...
export const metadata: Metadata = { title: "Conditions d'utilisation — FoodKlash" };
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          <section className="space-y-3">
            ...
            <p>
              En utilisant FoodKlash, vous acceptez les présentes conditions. Si vous n&apos;êtes pas
          ...
          <section className="space-y-3">
            ...
            <p>
              FoodKlash est accessible gratuitement. La création d&apos;un compte peut être requise pour
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              propriété de leurs ayants droit. FoodKlash n&apos;héberge aucun contenu culinaire
          ...
          <section className="space-y-3">
            ...
            <p>
              Pour toute question :{" "}
              <a href="mailto:contact@foodklash.app" style={{ color: "var(--accent)" }} className="hover:underline">
                contact@foodklash.app
              </a>
            </p>
          </section>
        </div>
