...
export async function generateMetadata({
  ...
  const description = bracket.theme
    ? `Jouez au bracket « ${bracket.title} » (${bracket.theme}) sur AnimeKlash. Écoutez les extraits et votez pour élire le champion.`
    : `Jouez au bracket « ${bracket.title} » sur AnimeKlash. Écoutez les extraits et votez pour élire le champion.`;
