...
export const metadata: Metadata = { title: "Exercer mes droits RGPD — AnimeKlash" };

const CONTACT_EMAIL = "contact@animeklash.com";
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          ...
          <section className="space-y-3">
            ...
            <div className="flex flex-wrap gap-3 pt-1">
              <a href={buildMailto("Demande RGPD - AnimeKlash")} className="btn-primary">
