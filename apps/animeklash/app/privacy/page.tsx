...
export const metadata: Metadata = { title: "Confidentialité — AnimeKlash" };
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          <section className="space-y-3">
            ...
            <p>
              Le responsable du traitement est AnimeKlash. Pour toute question relative aux donnees
              personnelles :{" "}
          ...
          <section className="space-y-3">
            ...
            <p>
              AnimeKlash utilise des cookies essentiels (authentification, session, consentement, mode
