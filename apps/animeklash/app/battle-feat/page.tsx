...
export const metadata: Metadata = buildPageMetadata({
  title: "BattleClash — Chaîne de co-apparitions",
  description:
    "Enchaînez les personnages d'animé qui se sont croisés. Solo contre IA ou défiez vos amis en multijoueur.",
  path: "/battle-feat",
});
    ...
    <div className="mx-auto w-full max-w-[1280px] px-1 py-5 sm:px-2 sm:py-6">
      <div className="mb-8 text-center sm:mb-10">
        ...
        <p className="mx-auto mt-3 max-w-3xl text-base sm:text-lg md:text-xl lg:text-2xl" style={{ color: "#8f93a0" }}>
          Enchaînez les personnages qui se sont croisés dans les mêmes animés. Solo contre IA ou
          duel multijoueur, jusqu&apos;au blocage final.
        </p>
      </div>
      ...
      <div className="mb-8 grid grid-cols-1 gap-5 md:grid-cols-2">
        ...
        >
          ...
          <p className="flex-1 text-base" style={{ color: "#a8adbb" }}>
            Affronte l&apos;IA dans un duel de co-apparitions. Choisis ton personnage de départ et
