...
const DIFFICULTY_DESC: Record<number, string> = {
  1: "20 sec — IA populaire, 4 propositions",
  2: "20 sec — IA élargie",
  3: "10 sec — IA niche",
};
...
export async function generateMetadata({
  ...
  if (!challenge) return { title: "Défi BattleClash introuvable" };

  return buildPageMetadata({
    title: challenge.title,
    description: `Défi BattleClash « ${challenge.title} » — enchaînez les co-apparitions à partir de ${challenge.startingArtistName}.`,
    ...
    <div className="mx-auto w-full max-w-[1080px] px-2 py-8">
      ...
      >
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          >
            <Swords size={18} /> Jouer ce BattleClash solo <ArrowRight size={16} />
          </Link>
        </div>
      </div>
