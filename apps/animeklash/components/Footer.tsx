  ...
  const columns = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: f.contact, href: "mailto:contact@animeklash.com" },
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            >
              <BrandMark size={36} />
              <div>
                <p className="text-[1.2rem] font-black leading-none tracking-tight">AnimeKlash</p>
                <p
      ...
      <div style={{ borderTop: "1px solid var(--border)" }}>
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
            <span>© 2026 AnimeKlash. {f.allRightsReserved}</span>
