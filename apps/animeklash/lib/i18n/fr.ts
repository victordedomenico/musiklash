...
export const fr: Dictionary = {
  ...
  homeHero: {
    ...
    title3: "en jeu.",
    subtitle:
      "AnimeKlash est l'arène ultime pour les mélomanes. Crée des tournois, défie tes amis et explore des milliers de créations uniques.",
  ...
  home: {
    ...
    feature1Text:
      "Élimine animé par animé jusqu'au grand vainqueur. Écoute 30 s par titre, vote, avance.",
    feature2Title: "Tierlists & Blindtests",
    feature2Text:
      "Classe tes animés et arcs du S au F, ou devine les openings à l'aveugle — idéal pour défier tes amis.",
