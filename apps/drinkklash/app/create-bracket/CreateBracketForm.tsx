...
import DrinkPicker, { type SelectedItem } from "@/components/DrinkPicker";
...
export default function CreateBracketForm() {
  ...
  const onSubmit: React.FormEventHandler<HTMLFormElement> = (e) => {
    ...
    if (selected.length < 3) {
      setError("Sélectionne au moins 3 boissons.");
      return;
    }
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      <DrinkPicker size={size} selected={selected} onChange={setSelected} />
