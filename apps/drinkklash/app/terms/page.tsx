...
export const metadata: Metadata = { title: "Conditions d'utilisation — DrinkKlash" };
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          <section className="space-y-3">
            ...
            <p>
              En utilisant DrinkKlash, vous acceptez les présentes conditions. Si vous n&apos;êtes pas
          ...
          <section className="space-y-3">
            ...
            <p>
              DrinkKlash est accessible gratuitement. La création d&apos;un compte peut être requise pour
          ...
          <section className="space-y-3">
            ...
            <p>
              Les images et métadonnées proviennent de TheCocktailDB et restent la
              propriété de leurs ayants droit. DrinkKlash n&apos;héberge aucun contenu média en local.
              L&apos;interface et le code sont protégés par le droit d&apos;auteur © 2026 DrinkKlash.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Pour toute question :{" "}
              <a href="mailto:contact@drinkklash.app" style={{ color: "var(--accent)" }} className="hover:underline">
                contact@drinkklash.app
              </a>
            </p>
          </section>
        </div>
