...
import { getTopFashion } from "@/lib/top-fashion";
import { absoluteUrl, buildPageMetadata, SITE_NAME } from "@/lib/seo";

export const metadata: Metadata = buildPageMetadata({
  title: "Tournois mode en ligne gratuits",
  description:
    "Crée des brackets et tierlists mode. Vote pour tes pièces, marques et styles préférés. FashionKlash — 100 % gratuit.",
  path: "/",
});

export default async function Home() {
  const { t } = await getI18n();
  const topFashion = await getTopFashion(18);
  const marqueeItems = topFashion.length > 0 ? [...topFashion, ...topFashion] : [];
    ...
    <>
      <JsonLd
        data={{
          ...
          url: absoluteUrl(),
          description:
            "Plateforme gratuite de jeux autour de la mode : brackets et tierlists de vêtements.",
        }}
      />
      <div className="space-y-4">
        ...
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(900px 480px at 55% 10%, rgba(236,72,153,0.22) 0%, rgba(244,114,182,0.10) 45%, transparent 78%)",
            }}
          />
          <div className="relative">
            ...
            >
              ...
              <span
                ...
                style={{
                  background: "linear-gradient(90deg, #ec4899 5%, #f472b6 45%, #fbcfe8 85%)",
