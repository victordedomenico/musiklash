...
import { getTopComics } from "@/lib/top-comics";
import { absoluteUrl, buildPageMetadata, SITE_NAME } from "@/lib/seo";

export const metadata: Metadata = buildPageMetadata({
  title: "Tournois comics en ligne gratuits",
  description:
    "Crée des brackets et tierlists comics. Vote pour tes numéros, personnages et arcs préférés. ComicKlash — 100 % gratuit.",
  path: "/",
});

export default async function Home() {
  const { t } = await getI18n();
  const topComics = await getTopComics(18);
  const marqueeItems = topComics.length > 0 ? [...topComics, ...topComics] : [];
    ...
    <>
      <JsonLd
        data={{
          ...
          url: absoluteUrl(),
          description:
            "Plateforme gratuite de jeux autour des comics : brackets et tierlists.",
        }}
      />
      <div className="space-y-4">
        ...
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(900px 480px at 55% 10%, rgba(239,68,68,0.22) 0%, rgba(248,113,113,0.10) 45%, transparent 78%)",
            }}
          />
          <div className="relative">
            ...
            >
              ...
              <span
                ...
                style={{
                  background: "linear-gradient(90deg, #ef4444 5%, #f87171 45%, #fecaca 85%)",
