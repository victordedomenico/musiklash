...
const branding = vertical.branding;

export const SITE_NAME = vertical.name;
export const SITE_TAGLINE = branding.tagline;
export const SITE_DESCRIPTION = branding.description;
export const SITE_KEYWORDS = branding.keywords;
...
export function getSiteUrl(): string {
  ...
  return branding.siteUrlFallback;
}
