...
import { signOut, updateGuestUsername } from "@klash/klash-app/app/(auth)/actions";
import ThemeToggle from "@klash/klash-app/components/ThemeToggle";
import LocaleToggle from "@klash/klash-app/components/LocaleToggle";
import SidebarNavLinks from "@klash/klash-app/components/SidebarNavLinks";
import SidebarVolumeControl from "@klash/klash-app/components/SidebarVolumeControl";
import { BrandMark } from "@klash/klash-app/components/BrandLogo";
import MobileNavDrawer from "@klash/klash-app/components/MobileNavDrawer";
      ...
      <aside className="site-sidebar hidden rounded-2xl border p-3 sm:p-4 lg:block lg:rounded-3xl lg:p-5">
        <div className="mb-6 flex items-center gap-3 px-1 lg:mb-8">
          ...
          <div>
            ...
            >
              {process.env.NEXT_PUBLIC_KLASH_NAME ?? "Klash"}
            </p>
            <p
