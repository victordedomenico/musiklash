...
import { saveCookieConsent } from "@klash/klash-app/app/preferences/actions";
import type { CookieConsent } from "@klash/klash-app/lib/cookie-consent";
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-1 text-sm" style={{ color: "var(--muted)" }}>
              Nous utilisons des cookies essentiels pour faire fonctionner {appName}. Les cookies
