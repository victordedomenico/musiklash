...
const itemNoun = process.env.NEXT_PUBLIC_KLASH_ITEM_NOUN ?? "morceau";
const itemsNoun = process.env.NEXT_PUBLIC_KLASH_ITEMS_NOUN ?? "morceaux";
      ...
      <div className="p-4">
        ...
        {sc.trackCount != null ? (
          <p className="mt-0.5 text-xs text-[color:var(--muted)]">
            {sc.trackCount} {sc.trackCount > 1 ? itemsNoun : itemNoun}
          </p>
        ) : null}
      </div>
    </>
    ...
    <>
      ...
      <div className="space-y-1 p-4">
        ...
        <p className="text-xs text-[color:var(--muted)]">
          {room.trackCount} {room.trackCount > 1 ? itemsNoun : itemNoun} ·{" "}
