...
import { signOut } from "@klash/klash-app/app/(auth)/actions";
import { ChevronDown, Library, Headphones, Music, Plus, Swords } from "lucide-react";
...
const BlindtestIcon = process.env.NEXT_PUBLIC_KLASH_MEDIA_ICON === "headphones" ? Headphones : Music;
              ...
              <div className="group relative">
                ...
                >
                  {[
                    ...
                    { href: "/create-blindtest", icon: <BlindtestIcon size={14} />, label: t.nav.createBlindtest },
                  ].map(({ href, icon, label }) => (
                    <Link
                      key={href}
                      href={href}
