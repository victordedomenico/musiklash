...
} from "@klash/klash-app/lib/tierlist-tiers";
import type { Dictionary } from "@klash/i18n";
...
export default function TierlistBoard({
  ...
  // Cache des URLs fraîches (les URLs signées peuvent expirer)
