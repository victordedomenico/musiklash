...
export default function CreateBattleFeatForm() {
  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    if (!startingEntity) {
      setError("Choisis une entité de départ.");
      return;
    }
    ...
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      <div>
        ...
        <Input
          ...
          placeholder="Ex. BattleFeat solo"
          maxLength={120}
        />
      </div>
      ...
      {/* Ligne 3 — Entité de départ */}
      <div>
        <label className="text-sm font-medium">Entité de départ</label>
        <div className="mt-1">
          {startingEntity ? (
            ...
            <EntitySearchInput
              ...
              placeholder="Recherche une entité de départ…"
            />
          )}
        </div>
      </div>
