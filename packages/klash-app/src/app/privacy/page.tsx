...
export const metadata: Metadata = { title: "Confidentialité — " + appName + "" };
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          <section className="space-y-3">
            ...
            <p>
              Le responsable du traitement est " + appName + ". Pour toute question relative aux donnees
              personnelles :{" "}
          ...
          <section className="space-y-3">
            ...
            <p>
              " + appName + " utilise des cookies essentiels (authentification, session, consentement, mode
