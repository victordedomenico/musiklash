...
import { ensureBattleFeatVisibilityColumns } from "@klash/klash-app/lib/ensure-battle-feat-visibility-columns";
import BracketCard, { type BracketSummary } from "@klash/klash-app/components/BracketCard";
import TierlistCard, { type TierlistSummary } from "@klash/klash-app/components/TierlistCard";
import BlindtestCard, { type BlindtestSummary } from "@klash/klash-app/components/BlindtestCard";
import BlindtestRoomCard, { type BlindtestRoomSummary } from "@klash/klash-app/components/BlindtestRoomCard";
import {
  BattleFeatRoomCard,
  type BattleFeatRoomSummary,
} from "@klash/klash-app/components/BattleFeatCard";
import BattleFeatChallengeCard, {
  type BattleFeatChallengeSummary,
} from "@klash/klash-app/components/BattleFeatChallengeCard";
import {
  StreamClashCard,
  StreamClashRoomCard,
  type StreamClashRoomSummary,
  type StreamClashSummary,
} from "@klash/klash-app/components/StreamClashCard";
import {
  SmashPassCard,
  SmashPassRoomCard,
  type SmashPassRoomSummary,
  type SmashPassSummary,
} from "@klash/klash-app/components/SmashPassExploreCard";
import { Search } from "lucide-react";
import { getI18n } from "@klash/klash-app/lib/i18n";
import { buildPageMetadata } from "@klash/klash-app/lib/seo";

export const metadata = buildPageMetadata({
  title: `Explorer les jeux ${process.env.NEXT_PUBLIC_KLASH_NAME ?? "Klash"}`,
  description:
    `Découvrez des brackets, tierlists, blindtests et plus, créés par la communauté ${process.env.NEXT_PUBLIC_KLASH_NAME ?? "Klash"}.`,
  path: "/explore",
});
