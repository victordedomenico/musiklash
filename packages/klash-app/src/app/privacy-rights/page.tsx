...
export const metadata: Metadata = { title: `Exercer mes droits RGPD — ${appName}` };

const CONTACT_EMAIL = "" + (process.env.NEXT_PUBLIC_KLASH_CONTACT_EMAIL ?? "contact@klash.app") + "";
        ...
        <div className="mt-10 space-y-8" style={{ color: "var(--muted-strong)", lineHeight: 1.8 }}>
          ...
          <section className="space-y-3">
            ...
            <div className="flex flex-wrap gap-3 pt-1">
              <a href={buildMailto(`Demande RGPD - ${appName}`)} className="btn-primary">
