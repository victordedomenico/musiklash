...
import SessionCard, { type SessionSummary } from "@klash/klash-app/components/SessionCard";
import {
  StreamClashCard,
  StreamClashRoomCard,
...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Retrouvez vos brackets, tierlists et blindtests sur " + appName + ".",
  path: "/my-library",
  noIndex: true,
});
