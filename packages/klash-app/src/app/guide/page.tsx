...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    "Apprenez à jouer aux brackets, tierlists, blindtests, BattleFeat et Stream Clash sur " + appName + ". Règles, création et partage expliqués pas à pas.",
  path: "/guide",
});
  ...
  const blocks = [
    ...
    },
    {
      ...
      steps: [
        ...
        "Barres room + stats communautaires " + appName + " à chaque révélation.",
