...
import { saveSoloSession } from "@klash/klash-app/app/battle-feat/solo/actions";
...
export default function BattleFeatFree() {
  ...
  const [startingArtist, setStartingArtist] = useState<BattleFeatEntity | null>(
    null,
  );
