...
import BattleFeatSolo, { type BattleFeatSoloChallengePreset } from "@klash/klash-app/app/battle-feat/solo/BattleFeatSolo";

const appName = process.env.NEXT_PUBLIC_KLASH_NAME ?? "Klash";

export const metadata: Metadata = { title: `BattleFeat Solo — ${appName}` };
