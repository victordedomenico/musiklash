export interface Dictionary {
  ...
  footer: {
    ...
    /** Short tagline shown in the footer brand column. */
    description: string;
  };
}

/** Base French dictionary (vertical overrides are deep-merged on top). */
export const fr: Dictionary = {
  ...
  footer: {
    ...
    description: "Fais s’affronter tes sons, partage tes classements, défie tes amis.",
  },
};
